...
CREATE TABLE EMPLOYEE_TBL (
    ...
    CONSTRAINT FK_DEPT_NO FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT_TBL(DEPT_NO) ON DELETE SET NULL  -- 부서가 없어지면 사원의 부서 정보만 NULL처리 된다. 사원의 다른정보는 다 남고,
);
...
CREATE TABLE PROCEEDING_TBL (
    ...
    CONSTRAINT FK_PJN_NO FOREIGN KEY(PJT_NO) REFERENCES PROJECT_TBL(PJT_NO) ON DELETE SET NULL
);

...
SELECT 
        TO_CHAR(100)             -- '100'
      , TO_CHAR(100, '999999')   -- '   100'   // 공백을 채운다.
      , TO_CHAR(100, '000000')   -- '000100'   // 0을 채운다.
...
-- 2) 날짜를 문자로 변환하기 (중요)
-- 날짜를 원하는 형식으로 변화할 때 사용한다.
-- '2023-02-07' -> '2023년 02월 07일'

-- 먼저, 현재 날짜와 시간 확인하기
SELECT 
      SYSDATE         -- DATE 타입의 현재 날짜와 시간
    , SYSTIMESTAMP    -- TIMESTAMP 타입의 현자 날짜와 시간
 FROM
      DUAL;
...
SELECT
      TO_DATE('05/06/07', 'YY/MM/DD')  -- 05년06월07일
    , TO_DATE('05/06/07', 'MM/DD/YY')  -- 07년05월06일
 FROM
      DUAL;

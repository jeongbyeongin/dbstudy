/*
    ...
    3. 조인 성능 향상을 위해서 가급적 드라이브(DRIVE) 테입을을 먼저 작성한다. 드리븐(DRIVEN) 테이블은 나중에 작성한다.
*/
...
DELETE FROM EMPLOYEE_TBL WHERE NAME = '김성실';   -- 인덱스를 타지않는 일반 칼럼은 느리게 동작 ( EX)서울에서 김서방찾기)
COMMIT;
